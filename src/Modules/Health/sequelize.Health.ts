...
import * as NestJSSequelize from '@contact/nestjs-sequelize';
...
export class SequelizeHealthIndicator extends HealthIndicator {
  ...
  private checkDependantPackages() {
    checkPackages(
      ['@contact/nestjs-sequelize', '@contact/sequelize'],
  ...
  private getContextConnection(): any | null {
    const { getConnectionToken } =
      ...
      require('@contact/nestjs-sequelize/dist/common/sequelize.utils') as typeof NestJSSequelize;
